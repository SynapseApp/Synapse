...
export default function AuthComponent({ setAuthenticated }) {
  ...
  return (
    <>
      ...
      <form id="Login-Component" onSubmit={handleSubmit}>
        ...
        <a id="Google-Auth-Button" className="gradient-box glow-effect-border" href="http://localhost:3000/login/federated/google">
